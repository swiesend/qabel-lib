/*
 * @file        qbl-json-chat-uuid.cpp
 * @brief       Class to handle uuid chat requests (Implementation)
...
QblJsonChatUuid::QblJsonChatUuid(std::string sender, int uuid, messageType type) :
...
QblJsonChatUuid::~QblJsonChatUuid()
{
    int i;
...
std::string QblJsonChatUuid::getJsonString()
{
    std::string result;
    int i, elements[] = { UUID_TO_SEND };
